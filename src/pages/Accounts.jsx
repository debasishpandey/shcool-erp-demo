  ...
  return (
    <>
              ...
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                  ...
                  <div className="bg-primary-50 p-4 rounded-lg border border-primary-100">
                    ...
                    <p className="text-xl font-bold text-primary-700">₹{netCollection.toLocaleString()}</p>
                  </div>
                </div>
      ...
      {/* PRINTABLE RECEIPT / MODAL 
          Rendered as a sibling to the .no-print wrapper so we can accurately display just the print-area
      */}
