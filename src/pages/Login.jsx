...
export default function Login() {
  ...
  const roles = [
    ...
    { id: 'teacher', title: 'Teacher', icon: Briefcase, color: 'bg-blue-100 text-blue-700', path: '/dashboard', desc: 'Manage classes, attendance & homework' },
    { id: 'accountant', title: 'Accountant', icon: BookOpen, color: 'bg-green-100 text-green-700', path: '/fees', desc: 'Manage fee collections & finances' },
